...
5. ~~**Faust WASM limiter**~~ — **shipped**: stereo-linked 5 ms look-ahead DSP compiles during dev/build; HQ live uses Faust + FIR meter and export uses Faust → 4× FIR guard with explicit fallbacks.
