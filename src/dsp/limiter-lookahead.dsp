/**
 * REFERENCE SPEC — NOT BUILT YET
 *
 * Look-ahead + 4× oversampling limiter design. Faust compile currently fails
 * (e.g. undefined peak_hold_tau). Kept as the target architecture.
 * The shipped export limiter is limiter.dsp (compressor + ceiling).
 *
 ...
 * 
 * COMPILATION:
 * faust2wasm -worklet limiter-lookahead.dsp  (fails — spec only)
 * 
 * This generates:
